    ...
    return (
        <div className="container_principal">
            ...
            <div className='w-full h-20 mt-44 flex flex-col justify-center items-center'>
                ...
                <input type='email' placeholder='Username' className='mt-7 border-2 rounded-lg' onChange={(e) => setUsername(e.target.value)} />
                <input type='password' placeholder='Password' className='mt-7 border-2 rounded-lg' onChange={(e) => setPassword(e.target.value)} />
                <input type='text' placeholder='Nombre' className='mt-7 border-2 rounded-lg' onChange={(e) => setNames(e.target.value)} />
                <input type='text' placeholder='Apellido' className='mt-7 border-2 rounded-lg' onChange={(e) => setLastNames(e.target.value)} />
                <input type='email' placeholder='Email' className='mt-7 border-2 rounded-lg' onChange={(e) => setEmail(e.target.value)} />
